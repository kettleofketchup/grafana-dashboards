...
def _get_version(dist: str = "grafana-dashboards") -> str:
...
def _get_debug_info() -> _Environment:
    ...
    packages = ["grafana-dashboards"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("GRAFANA_DASHBOARDS")]]
    return _Environment(
